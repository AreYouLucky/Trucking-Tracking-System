<template>
    <v-sheet elevation="12" max-width="100vw" rounded="lg" width="100%" class="pa-10 text-center mx-auto">
        <h2 class="text-h6 mb-6 text-medium-emphasis">The system has a total of <b class="text-h3 text-blue">{{
            data.totalCustomer }}</b> registered customer(s).</h2>

        <v-divider class="mb-4"></v-divider>
        <v-row class="justify-center">
            <v-col cols="12" md="3">
                <v-sheet border="md" class="text-body-2 mx-auto pa-3" max-width="550" color="blue-darken-4">
                    <v-row class="ma-1 justify-center text-medium-emphasis">
                    ...
                    <v-divider></v-divider>
                    <v-row class="mt-2 justify-center text-medium-emphasis text-h7">
            ...
            <v-col cols="12" md="4">
                <v-sheet border="md" class="text-body-2 mx-auto pa-3" max-width="550" color="pink-darken-4">
                    <v-row class="ma-1 justify-center text-medium-emphasis">
                        <v-icon size="x-large" color="mb-2">
                            mdi-credit-card-marker
                        </v-icon>
                        <h2 class="text-h6 mx-2"><b>DELIVERIES</b></h2>
                    </v-row>
                    <v-divider></v-divider>
                    <v-row class="mt-2 justify-center text-medium-emphasis text-h7">
            ...
            <v-col cols="12" md="3">
                <v-sheet border="md" class="text-body-2 mx-auto pa-3" max-width="550" color="deep-purple-darken-4">
                    <v-row class="ma-1 justify-center text-medium-emphasis">
                        <v-icon size="x-large" color="mb-2">
                            mdi-truck-delivery
                        </v-icon>
